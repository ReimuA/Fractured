...
\r
fn defaultColoring(idx: u32) -> vec3<f32> {\r
...
\r
    ...
    var c: vec3<f32>;\r
    if renderMode == DEFAULT {\r
        c = defaultColoring(hIdx) * 255.;\r
    }\r
